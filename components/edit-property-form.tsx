...
import { ArrowLeft, Camera, Star, X, Plus, Trash2 } from "lucide-react";
...
import { updateProperty, deleteProperty } from "@/app/actions/property-actions";
...
export function EditPropertyForm({ property, propertyTypes }: EditPropertyFormProps) {
    ...
    const [existingImages, setExistingImages] = useState<string[]>(
        property.PropertyImage?.map(img => img.image_url) || []
    );
    ...
    const form = useForm<z.infer<typeof formSchema>>({
        ...
        defaultValues: {
            ...
            city: property.city || "",
            priceDay: property.price?.toString() || "",
    ...
    const onSubmit = (values: z.infer<typeof formSchema>) => {
        startTransition(async () => {
            try {
                ...
                // Append deleted image URLs (images that were in original but not in current)
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            {existingImages.length > 0 && (
                                <div className="mb-4">
                                    <FormLabel className="text-sm text-gray-600 mb-2 block">Current Images</FormLabel>
                        ...
                        <div className="space-y-4 pt-6">
                            ...
                            >
                                {isPending ? "Updating Property..." : "Save Property"}
                            </Button>
                            ...
                            <AlertDialog>
                                <AlertDialogTrigger asChild>
                                    <Button
                                        type="button"
                                        variant="outline"
                                        className="w-full h-14 border-red-200 text-red-600 hover:bg-red-50 hover:border-red-300 font-semibold text-lg rounded-xl transition-all duration-200"
                                    >
